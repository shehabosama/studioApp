...
public class SettingActivity_photographer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setting_photographer);
        ...
        profileImage=findViewById(R.id.image_profile_setting);
        userStatus= findViewById(R.id.status_setting);
        userName=findViewById(R.id.user_name_setting);
        user_phone_number=findViewById(R.id.phone_number);
        userCountry=findViewById(R.id.country_setting);
        userGender=findViewById(R.id.gender_setting);
        update_account_button=findViewById(R.id.save_change_settings);

        mAuth=FirebaseAuth.getInstance();

        current_user_id=mAuth.getCurrentUser().getUid();
        usersettingref= FirebaseDatabase.getInstance().getReference().child("Photographer").child(current_user_id);
        usersettingref2= FirebaseDatabase.getInstance().getReference().child("Photographer").child(current_user_id);
        UserprofileImageStorge= FirebaseStorage.getInstance().getReference().child("profile image photographer");
        ...
        profileImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                CropImage.activity()
                        ...
                        .start(SettingActivity_photographer.this);
            }
        });
            ...
            public void onClick(View v) {
                ...
                usersettingref2.updateChildren(userMap).addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        ...
                        {
                            Toast.makeText(getBaseContext(),R.string.update_successfully,Toast.LENGTH_LONG).show();
                        }
                    }
                });
            }
        ...
        usersettingref2.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.exists())
                {
                    ...
                    {
                        String Image = dataSnapshot.child("profilimage_photo").getValue().toString();
                ...
                filePath.putFile(resulturi).addOnCompleteListener(new OnCompleteListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                        ...
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(SettingActivity_photographer.this, R.string.image_uploaded_successfully, Toast.LENGTH_SHORT).show();

                            usersettingref2.child("profilimage_photo").setValue(downloadUrl)
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task)
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                Toast.makeText(SettingActivity_photographer.this, R.string.Error+message, Toast.LENGTH_SHORT).show();
                                                lodingbar.dismiss();
